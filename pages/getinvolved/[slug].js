...
{/* -webkit-text-stroke: 2px black; */}
      ...
      <Link href="../../videoBlogPost/our-story"><a className=' font-semibold p-3 hover:text-[#85ff85]' > ☆‘about’☆ </a></Link>
      section, we have a small core   
       <Link href="../../theteam"><a className=' font-semibold p-3 hover:text-[#85ff85]' > ☆team☆ </a></Link>
       supported by many
        <Link href="../collaborators"><a className=' font-semibold p-3 hover:text-[#92ff92]' > ☆collaborators☆ </a></Link>
