...
{/* -------------------------------------------- left */}
        <div className=' mx-auto z-0 h-screen '>
        ...
        <div className=" flex-auto mb-2 w-full  text[red]">
                    <h1 className={styles.crytextmobile}>{title}</h1>
                </div> 

<div>
<section className=" justify-center  m-auto text-left text-xl font-['Helvetica Neue LT'] leading-snug font-normal reletive flex  z-50 ">
<div className=''>
...
<div className={`container mx-auto flex items-center   ${styles.wrappermobile}`}>
<div className={"flex-auto flex-col md:flex-row items-center  bg-[#ffffff] drop-shadow-lg shadow-[#f70909] rounded-xl  " + styles.shadow}>
<section className=' justify-center  reletive flex    z-50 '>
<div className=' py-8  px-8 font-black text-3xl tracking-wide'>
...
<section  className=' font-bold reletive text-xl flex   z-50 '>
<BlockContent blocks={communitiesUk} />
</section>


<section  className="text-xl font-['Helvetica Neue LT'] leading-snug reletive   z-50 ">
<div className={styles.body}>
<BlockContent className={styles.body} blocks={communitiesGlobal} />
        </div>
</section>
<section  className="text-xl font-['Helvetica Neue LT'] leading-snug reletive pl-10   z-50 ">
<div className={styles.body}>
...
<section className="text-xl font-['Helvetica Neue LT'] leading-snug reletive   z-50 ">
<div className={styles.body}>
        <Link href="../resources/resources-for-qtibpoc-healing"><p className="text-2xl  text-center italic pt-10 pb-32 font-semibold  "> if you’re looking for more resources: click here </p></Link>
        </div>
</section>
